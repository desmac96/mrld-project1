...
<p>MRLD is an electronic music hub offering a variety of services. The website offers DJ services to hire, equipment to rent, mixing engineers, and also a school teaching students about various electronic music topics.</p>

<p>The website provides information about the services offered and also offers a form where you can sign up for courses and ask any questions. You need to provide your full name, email address, and mobile phone number to fill in the form.</p>

<p>When signing up, you are given the option of signing up for the newsletter by clicking on the checkbox provided. The website provides external links to all MRLD's social media pages. There is also a mixes page that has embedded SoundCloud links.</p>

<img src="assets/images/mrld-amiresponsive.png" alt="amiresponsive">
...
<h3>Logo</h3>
<p>The logo is situated in the top left-hand corner of the home page. The print is in white and is big and bold, immediately catching the user's eye and making it clear what website you are on. The logo is a clickable link that brings you to the home page, which is a common feature on all websites.</p>

<h3>Navigation Bar</h3>
<p>The Navigation Bar contains three links:</p>
<ul>
...
<h3>Landing Page</h3>
<p>The landing page has an eye-catching image. The image contains the MRLD logo and a crowd at a party. There is also information beneath the hero image informing the user of the services that MRLD offers.</p>

<h3>Mixes</h3>
<p>The mixes' link is the second link on the nav bar. This page allows the user to listen to MRLD's radio show via the embedded SoundCloud player.</p>

<h3>Form</h3>
<p>This section is the key section of the webpage. The form is on the right side of the nav bar. This is where the user provides their details and chooses what services they need.</p>

<h3>Footer</h3>
<p>The footer section includes external links to all MRLD's social media pages. There are links to contact MRLD by email or phone call. Finally, there is a location symbol that brings you to MRLD's location on the maps. All these links are shown by a suitable symbol.</p>
...
<h3>Colour Scheme</h3>
<p>The two main colours used are black and white. They work well with the colours in the hero image. Green is also used for the sign-up form button to match the green in the hero image.</p>

<h3>Typography</h3>
<p>The two fonts used on this website are Montserrat and Kanit. They were imported through Google Fonts. They are quite similar and work well together. Their style suits the kind of website MRLD needed. Sans Serif is the fallback font in case the custom fonts are not imported correctly. I got inspiration to use the Montserrat font from the PIV Records website.</p>

<h3>Imagery</h3>
<p>Imagery is very important when building a website. The large background hero image is designed to catch the user's eye and also familiarize the user with the MRLD logo.</p>
...
<img src="assets/images/css-validation.png" alt="CSS Validation Results">
<img src="assets/images/mrld-lighthouse.png" alt="Lighthouse Results">
