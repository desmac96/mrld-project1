...
<h1>MRLD</h1>
<br>
<p>MRLD is an electronic music hub offering a variety of services. The website offers DJ services to hire, equipment to rent, mixing engineers and also a school teaching students about various electronic music topics. 
...
When signing up you are given the option of signing up for the newsletter also by clicking on the checkbox provided. The website provides external links to all MRLD's social media pages. There is also a mixes page that has embedded soundcloud links. </p>
...
<h3>Logo</h3>
<p>The logo is situated in the top left hand corner of the home page. The print is in white and is big and bold immediately catching the user's eye and making it clear what website you are on. The logo is a clickable link that brings you to the home page.  This is a common feature on all websites. </p>
...
<p>
The landing page has an eye catching image. The image contains the MRLD logo and also a crowd at a party. There is also information beneath the hero image informing the user of the sevices that MRLD offers.
</p>
<h3>
Mixes
</h3>
...
<li>Balsamiq:
I used Balsamiq to create wireframes when planning the project</li>

![alt text](assets/images/mrld-wireframes.png)
...
<ul>As a returning visitor I  want to find the best ways to contact MRLD.</ul>
